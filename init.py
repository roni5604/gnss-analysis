...
def calculate_satellite_position(ephemeris, transmit_time):
    ...
    # LIGHTSPEED = 2.99792458e8
    # pr = transmit_time['PrM'] + LIGHTSPEED * sv_position['delT_sv']
    # sv_position['pr'] = pr.to_numpy()
    #
    #
    # ### TIMESTAMP ##### Check if correct
    # sv_position['gps_time'] = transmit_time.iloc[0]['UnixTime'].to_pydatetime(warn=False)
